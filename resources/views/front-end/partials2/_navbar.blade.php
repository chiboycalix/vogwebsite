    ...
    <a class="navbar-brand" href="{{route('members')}}" id="vog-text">Vessels of Glory</a>
      ...
      <div class="collapse navbar-collapse " id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto" style="position:relative; left:5%;">
          ...
          <li class="nav-item active">
            <a class="nav-link" href="{{route('members')}}">All Members <span class="sr-only">(current)</span></a>
            </li>                
        </ul>
